...
const useInput = (initialValue) => {
    ...
    /*
        FormInput 의 값이 바뀔 때마다 여기서 setEmail 할 것이다 (입력할 때마다 onChange 함수를 실행해서 상태를 바꿔주겠다는 애기이다)
    ...
    */
    ...
    //-->  배열이나 객체로 반환하면 된다
    //-->  "배열" 로 반환해준 이유는, 구조분해할당으로 이 useInput 함수를 선언할 때 이름을 내 마음대로 바꿔주기 위함이다 (email 이 될 수도 있고 password 가 될 수도 있다)
