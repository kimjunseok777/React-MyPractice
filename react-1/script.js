...
// submit 이벤트를 넣게 되면, 이벤트에 formEvent 라는 친구가 전달이 된다
$form.addEventListener('submit', (event) => {
    ...
    //--> name="email"  -->  이렇게 속성으로 name 값을 지정해줬다
...
/*
    ...
    -->  이런 습관 (기존에 있는 이벤트) 을 막는 기능을 사용해야한다
...
/*
    form 을 사용하는 이유 :
        ...
        3. 유효성 검사 :
            ...
            ==> 나중에 이런 유효성 검사를 해주는 라이브러리를 사용할거다
    ...
    --> form 태그는 원래는 action으로 데이터를 보내기 위해서 사용했던 것이다
            하지만, 요즘에는 JavaScript 에서 fetch 나 axios 같은 편의성을 가진
